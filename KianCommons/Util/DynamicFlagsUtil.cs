...
public static class DynamicFlagsUtil {
    ...
    public readonly static DynamicFlags<NetInfo> NONE = new DynamicFlags<NetInfo>(EMPTY_FLAGS);
    ...
    public static bool IsAnyFlagSetOrEmpty(this DynamicFlags<NetInfo> flags, DynamicFlags<NetInfo> flags2) =>
